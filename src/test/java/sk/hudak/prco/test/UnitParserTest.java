...
public class UnitParserTest {
    ...
    public void parseTest() {
        ...
        addTestData(values,"1x132 kusov",
                KUS, "132", 1);
        addTestData(values, "Pampers Plienky Veľ. 2, 40 Plienok, 4-8 kg",
                KUS, "40", 1);
        addTestData(values, "Pampers Premium Care Veľkosť 5, Plienky x88, 11kg-16kg",
                KUS, "88", 1);
        addTestData(values,"Pampers New Baby 1 Newborn - 2 x 43 ks",
                KUS, "43", 2);
...
//                Unit.LITER, "1", 1);
        ...
        addTestData(values, "LOVELA 5.4 KG + LOVELA AVIÁŽ.",
                KILOGRAM, "5.4", 1);
        addTestData(values, "Lovela Color prací prášok 5kg - 40 PD",
                KILOGRAM, "5", 1);
        addTestData(values, "lovela color 5kg",
                KILOGRAM, "5", 1);
        addTestData(values,"Nutrilon 2 600g 5pack",
                KILOGRAM, "0.60000", 5);
        addTestData(values,"Nutrilon 2 600g 5pack",
                KILOGRAM, "0.60000", 5);
