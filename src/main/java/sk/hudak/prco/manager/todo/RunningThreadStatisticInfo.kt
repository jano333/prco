package sk.hudak.prco.manager.todo
...
class RunningThreadStatisticInfo(private val addProductExecutors: AddProductExecutors,
                                 ...
                                 private val eshopExecutors: EshopExecutors) {
    ...
    private fun showUpdateProcess() {
        ...
        EshopUuid.values().forEach { eshopUuid ->
            val eshopExecutor: ScheduledExecutorService = eshopExecutors.getEshopExecutor(eshopUuid)
